import { $ as createTextVNode, $n as toRefs, Cn as withDirectives, Dt as mergeProps, Ft as onMounted, G as createBlock, Jt as renderSlot, K as createCommentVNode, Kn as ref, M as Fragment, Ot as nextTick, Qn as toRef, Rn as isRef, T as withModifiers, U as computed, Ut as provide, Vt as openBlock, W as createBaseVNode, Wn as reactive, Xt as resolveDirective, Yt as resolveComponent, Zt as resolveDynamicComponent, _n as watchEffect, an as toHandlers, ar as normalizeClass, cr as toDisplayString, et as createVNode, ft as guardReactiveProps, gn as watch, n as Transition, nr as unref, nt as defineComponent, or as normalizeProps, q as createElementBlock, qt as renderList, sr as normalizeStyle, w as withKeys, xn as withCtx, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-C6sZGmPl.js";
var bottom = "bottom";
var right = "right";
var left = "left";
var auto = "auto";
...
//#endregion
//#region node_modules/v-calendar/dist/es/index.js
...
var _freeGlobal = typeof commonjsGlobal == "object" && commonjsGlobal && commonjsGlobal.Object === Object && commonjsGlobal;
var freeGlobal = _freeGlobal;
var freeSelf = typeof self == "object" && self && self.Object === Object && self;
var _root = freeGlobal || freeSelf || Function("return this")();
...
function isKey$3(value, object) {
	if (isArray$b(value)) return false;
...
function isFunction$3(value) {
	if (!isObject$9(value)) return false;
...
function baseIsNative$1(value) {
	if (!isObject$8(value) || isMasked(value)) return false;
...
function listCacheDelete$1(key) {
	...
	if (index2 == data2.length - 1) data2.pop();
...
var memoizeCapped = memoizeCapped$1;
var rePropName = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g;
var reEscapeChar = /\\(\\)?/g;
var _stringToPath = memoizeCapped(function(string) {
	var result = [];
...
function baseToString$1(value) {
	...
	if (isArray$a(value)) return arrayMap(value, baseToString$1) + "";
	if (isSymbol$1(value)) return symbolToString ? symbolToString.call(value) : "";
	var result = value + "";
	return result == "0" && 1 / value == -INFINITY$1 ? "-0" : result;
}
var baseToString = baseToString$1;
...
function castPath$2(value, object) {
	if (isArray$9(value)) return value;
...
var baseIsArguments = baseIsArguments$1, isObjectLike$8 = isObjectLike_1;
var objectProto$a = Object.prototype;
var hasOwnProperty$8 = objectProto$a.hasOwnProperty;
var propertyIsEnumerable$1 = objectProto$a.propertyIsEnumerable;
var isArguments_1 = baseIsArguments(function() {
	return arguments;
...
(function(module, exports) {
	...
	var freeProcess = freeModule && freeModule.exports === freeExports && freeGlobal2.process;
...
var isDate_1 = nodeIsDate ? baseUnary$1(nodeIsDate) : baseIsDate;
...
function arraySome$2(array, predicate) {
	...
	while (++index2 < length) if (predicate(array[index2], index2, array)) return true;
	return false;
}
...
function equalByTag$1(object, other, tag, bitmask, customizer, equalFunc, stack) {
	switch (tag) {
		...
		case boolTag$2:
		case dateTag$1:
		case numberTag$2: return eq$4(+object, +other);
...
var arrayPush = arrayPush$1, isArray$6 = isArray_1;
...
var _getSymbols = !nativeGetSymbols ? stubArray : function(object) {
...
(function(module, exports) {
	...
	var freeExports = exports && !exports.nodeType && exports;
	var freeModule = freeExports && module && !module.nodeType && module;
	var Buffer2 = freeModule && freeModule.exports === freeExports ? root2.Buffer : void 0;
	module.exports = (Buffer2 ? Buffer2.isBuffer : void 0) || stubFalse2;
...
var baseIsTypedArray = baseIsTypedArray$1, baseUnary = _baseUnary, nodeUtil = _nodeUtilExports;
var nodeIsTypedArray = nodeUtil && nodeUtil.isTypedArray;
var isTypedArray_1 = nodeIsTypedArray ? baseUnary(nodeIsTypedArray) : baseIsTypedArray;
...
function arrayLikeKeys$2(value, inherited) {
	...
	for (var key in value) if ((inherited || hasOwnProperty$7.call(value, key)) && !(skipIndexes && (key == "length" || isBuff && (key == "offset" || key == "parent") || isType && (key == "buffer" || key == "byteLength" || key == "byteOffset") || isIndex$1(key, length)))) result.push(key);
	return result;
}
...
function isPrototype$3(value) {
	...
	return value === (typeof Ctor == "function" && Ctor.prototype || objectProto$7);
}
...
var _nativeKeys = _overArg(Object.keys, Object);
...
var DataView = _DataView, Map$3 = _Map, Promise$1 = _Promise, Set$1 = _Set, WeakMap = _WeakMap, baseGetTag$3 = _baseGetTag, toSource = _toSource;
...
var dataViewCtorString = toSource(DataView), mapCtorString = toSource(Map$3), promiseCtorString = toSource(Promise$1), setCtorString = toSource(Set$1), weakMapCtorString = toSource(WeakMap);
var getTag$1 = baseGetTag$3;
if (DataView && getTag$1(new DataView(/* @__PURE__ */ new ArrayBuffer(1))) != dataViewTag || Map$3 && getTag$1(new Map$3()) != mapTag || Promise$1 && getTag$1(Promise$1.resolve()) != promiseTag || Set$1 && getTag$1(new Set$1()) != setTag || WeakMap && getTag$1(new WeakMap()) != weakMapTag) getTag$1 = function(value) {
...
var baseIsEqualDeep = baseIsEqualDeep$1, isObjectLike$4 = isObjectLike_1;
...
function baseGet$2(object, path) {
	...
	while (object != null && index2 < length) object = object[toKey$2(path[index2++])];
...
var baseHasIn = baseHasIn$1, hasPath = _hasPath;
...
function createBaseEach$1(eachFunc, fromRight) {
	return function(collection, iteratee) {
		...
		while (fromRight ? index2-- : ++index2 < length) if (iteratee(iterable[index2], index2, iterable) === false) break;
		return collection;
	};
}
var baseEach = createBaseEach$1(_baseForOwn);
...
function isIterateeCall$3(value, index2, object) {
	if (!isObject$6(object)) return false;
	var type = typeof index2;
	if (type == "number" ? isArrayLike$2(object) && isIndex(index2, object.length) : type == "string" && index2 in object) return eq$3(object[index2], value);
	return false;
}
...
function some(collection, predicate, guard) {
	...
	if (guard && isIterateeCall$2(collection, predicate, guard)) predicate = void 0;
...
function assignValue$1(object, key, value) {
	...
	if (!(hasOwnProperty$3.call(object, key) && eq$2(objValue, value)) || value === void 0 && !(key in object)) baseAssignValue$3(object, key, value);
}
...
var constant = constant$1, defineProperty = _defineProperty;
var _baseSetToString = !defineProperty ? identity_1 : function(func, string) {
...
var _setToString = shortOut$1(_baseSetToString);
...
var defaults_1 = baseRest$2(function(object, sources) {
	object = Object(object);
	var index2 = -1;
	var length = sources.length;
	var guard = length > 2 ? sources[2] : void 0;
	if (guard && isIterateeCall$1(sources[0], sources[1], guard)) length = 1;
	while (++index2 < length) {
...
(function(module, exports) {
	...
	var freeExports = exports && !exports.nodeType && exports;
	var freeModule = freeExports && module && !module.nodeType && module;
	var Buffer2 = freeModule && freeModule.exports === freeExports ? root2.Buffer : void 0, allocUnsafe = Buffer2 ? Buffer2.allocUnsafe : void 0;
...
var cloneArrayBuffer = cloneArrayBuffer$1;
...
var _getPrototype = _overArg(Object.getPrototypeOf, Object);
...
var copyObject = copyObject$1, keysIn$1 = keysIn_1;
...
function baseMerge$2(object, source, srcIndex, customizer, stack) {
	...
	baseFor(source, function(srcValue, key) {
		...
		if (isObject$2(srcValue)) baseMergeDeep(object, source, key, srcIndex, baseMerge$2, customizer, stack);
		else {
...
var mergeWith_1 = _createAssigner(function(object, source, srcIndex, customizer) {
	baseMerge(object, source, srcIndex, customizer);
});
var apply = _apply, baseRest = _baseRest, customDefaultsMerge = _customDefaultsMerge, mergeWith = mergeWith_1;
var defaultsDeep_1 = baseRest(function(args) {
...
var omit = (obj, ...keys2) => {
	const ret = {};
	let key;
	for (key in obj) if (!keys2.includes(key)) ret[key] = obj[key];
	return ret;
};
var pick = (obj, keys2) => {
	const ret = {};
...
var toInteger$1 = /* @__PURE__ */ getDefaultExportFromCjs(toIntegerExports);
...
}, getTimezoneOffsetInMillisecondsExports);
var getTimezoneOffsetInMilliseconds$1 = /* @__PURE__ */ getDefaultExportFromCjs(getTimezoneOffsetInMillisecondsExports);
...
function getDateTimeFormat(timeZone) {
	if (!dtfCache[timeZone]) {
		...
		dtfCache[timeZone] = testDateFormatted === "06/25/2014, 00:00:00" || testDateFormatted === "‎06‎/‎25‎/‎2014‎ ‎00‎:‎00‎:‎00" ? new Intl.DateTimeFormat("en-US", {
			hour12: false,
			timeZone,
			year: "numeric",
			month: "numeric",
...
function tzParseTimezone(timezoneString, date, isUtcDate) {
	...
	if (token2) {
		...
		if (!validateTimezone(hours2)) return NaN;
	...
	if (token2) {
		...
		if (!validateTimezone(hours2, minutes)) return NaN;
	...
	if (isValidTimezoneIANAString(timezoneString)) {
		...
		var offset = calcOffset(isUtcDate ? date : toUtcDate(date), timezoneString);
...
function fixOffset(date, offset, timezoneString) {
	var utcGuess = date.getTime() - offset;
...
var tzPattern$1 = /(Z|[+-]\d{2}(?::?\d{2})?| UTC| [a-zA-Z]+\/[a-zA-Z_]+(?:\/[a-zA-Z_]+)?)$/;
...
function toDate$1(argument, dirtyOptions) {
	...
	else if (!(typeof argument === "string" || Object.prototype.toString.call(argument) === "[object String]")) return /* @__PURE__ */ new Date(NaN);
	var dateStrings = splitDateString(argument);
	var parseYearResult = parseYear(dateStrings.date, additionalDigits);
	var year = parseYearResult.year;
	var restDateString = parseYearResult.restDateString;
	var date = parseDate$1(restDateString, year);
	if (isNaN(date)) return /* @__PURE__ */ new Date(NaN);
	if (date) {
...
function parseYear(dateString, additionalDigits) {
	...
	var token2 = patterns.YYYY.exec(dateString) || patternYYYYY.exec(dateString);
	if (token2) {
...
function parseDate$1(dateString, year) {
	...
	if (token2) {
		...
		if (!validateWeekDate(year, week)) return /* @__PURE__ */ new Date(NaN);
...
function parseTime(timeString) {
	...
	if (token2) {
		...
		if (!validateTime(hours2)) return NaN;
	...
	if (token2) {
		...
		if (!validateTime(hours2, minutes)) return NaN;
	...
	if (token2) {
		...
		if (!validateTime(hours2, minutes, seconds)) return NaN;
...
function validateTime(hours2, minutes, seconds) {
	if (hours2 != null && (hours2 < 0 || hours2 >= 25)) return false;
...
function getDays({ monthComps, prevMonthComps, nextMonthComps }, locale) {
	const days = [];
...
function getWeeks(days, showWeeknumbers, showIsoWeeknumbers, locale) {
	...
	result.forEach((week) => {
		...
		if (fromDay.month === toDay.month) week.title = `${locale.formatDate(fromDay.date, "MMMM YYYY")}`;
		else if (fromDay.year === toDay.year) week.title = `${locale.formatDate(fromDay.date, "MMM")} - ${locale.formatDate(toDay.date, "MMM YYYY")}`;
		else week.title = `${locale.formatDate(fromDay.date, "MMM YYYY")} - ${locale.formatDate(toDay.date, "MMM YYYY")}`;
	});
	return result;
}
...
function addPages({ day, week, month, year }, count, view, locale) {
	if (view === "daily" && day) {
		const newDate = addDays(new Date(year, month - 1, day), count);
		return {
			day: newDate.getDate(),
		...
		const date = locale.getMonthParts(month, year).firstDayOfMonth;
		...
		const newDate = addMonths(new Date(year, month - 1, 1), count);
		return {
			month: newDate.getMonth() + 1,
			year: newDate.getFullYear()
		};
...
function pageIsBeforePage(page, comparePage) {
	...
	if (page.week && comparePage.week && page.week !== comparePage.week) return page.week < comparePage.week;
	if (page.day && comparePage.day && page.day !== comparePage.day) return page.day < comparePage.day;
	return false;
}
...
function getPage(config, cachedPage) {
	...
	switch (view) {
		case "daily": {
			...
			if (day) dayObj = page.days.find((d) => d.day === day && d.inMonth) || dayObj;
			else if (week) dayObj = page.days.find((d) => d.week === week && d.inMonth);
...
var Cache = class {
	...
	getOrSet(...args) {
		...
		if (this.keys.length >= this.size) {
			...
			if (removeKey != null) delete this.store[removeKey];
		}
		this.keys.push(key);
		this.store[key] = item;
		return item;
...
var DateRange = class DateRange {
	constructor(config, locale = new Locale()) {
		...
		if (isDate(start)) this.start = locale.getDateParts(start);
		if (isDate(end)) this.end = locale.getDateParts(end);
		else if (this.start != null && span) this.end = locale.getDateParts(addDays(this.start.date, span - 1));
		this.order = order ?? 0;
		if (repeat) this.repeat = new DateRepeat({
	...
	static from(source, locale) {
		...
		if (source != null) if (isArray(source)) {
			config.start = source[0] ?? null;
			config.end = source[1] ?? null;
		} else if (isObject(source)) Object.assign(config, source);
		else {
			config.start = source;
			config.end = source;
		}
...
var DateRangeContext = class {
	...
	render(data2, range, days) {
		...
		if (range.hasRepeat) days.forEach((day) => {
			var _a2, _b2;
	...
	getCell(key, day) {
		return this.getCells(day).find((cell) => cell.data.key === key);
	}
...
var state = reactive({
	...
	locales: Object.entries(locales).reduce((res, [id, { dow, L }]) => {
		res[id] = {
			id,
			firstDayOfWeek: dow,
			masks: { L }
...
var getDefault = (path) => {
	if (typeof window !== "undefined" && has(window.__vcalendar__, path)) return get_1(window.__vcalendar__, path);
...
function resolveConfig(config, locales2) {
	...
	return isObject(config) ? defaultsDeep_1(config, defLocale) : defLocale;
}
var Locale = class {
	...
	toDate(d, opts = {}) {
		...
		if (result && (patch || rules)) {
			...
			if (rules) parts = applyRulesForDateParts(parts, rules);
	...
	fromDate(date, { type, mask } = {}) {
		switch (type) {
			case "number": return date ? date.getTime() : NaN;
			case "string": return date ? this.formatDate(date, mask || "iso") : "";
			case "object": return date ? this.getDateParts(date) : null;
			default: return date ? new Date(date) : null;
		}
	}
	range(source) {
	...
	getPage(config) {
		return getPage(config, this.pageCache.getOrSet(config, this));
	}
...
var IntervalRule = class {
	...
	passes(dateParts) {
		...
		switch (this.type) {
			case "days": return diffInDays(this.from.date, date) % this.interval === 0;
			case "weeks": return diffInWeeks(this.from.date, date) % this.interval === 0;
			case "months": return diffInMonths(this.from.date, date) % this.interval === 0;
			case "years": return diffInYears(this.from.date, date) % this.interval === 0;
...
var ComponentRule = class {
	...
	static create(type, config) {
		switch (type) {
			case "days": return new DaysRule(config);
			case "weekdays": return new WeekdaysRule(config);
			case "weeks": return new WeeksRule(config);
			case "months": return new MonthsRule(config);
			case "years": return new YearsRule(config);
		}
	}
	...
	passes(dayParts) {
		return this.getter(dayParts).some((comp) => this.components.includes(comp));
	}
};
var DaysRule = class extends ComponentRule {
	constructor(components2) {
		super("days", components2, isDayInMonth, ({ day, dayFromEnd }) => [day, -dayFromEnd]);
	}
};
var WeekdaysRule = class extends ComponentRule {
	constructor(components2) {
		super("weekdays", components2, isDayOfWeek, ({ weekday }) => [weekday]);
	}
};
var WeeksRule = class extends ComponentRule {
	constructor(components2) {
		super("weeks", components2, isWeekInMonth, ({ week, weekFromEnd }) => [week, -weekFromEnd]);
	}
};
var MonthsRule = class extends ComponentRule {
	constructor(components2) {
		super("months", components2, isMonthInYear, ({ month }) => [month]);
	}
};
...
var OrdinalComponentRule = class {
	...
	normalizeArrayConfig(config) {
		...
		config.forEach((numOrArray, i) => {
			...
			} else if (isArray(numOrArray)) result.push(...this.normalizeArrayConfig(numOrArray));
		});
		return result;
	}
...
var DateRepeat = class DateRepeat {
	...
	getObjectRules(config) {
		const rules = [];
		if (config.every) {
			if (isString_1(config.every)) config.every = [1, `${config.every}s`];
	...
	passes(dayParts) {
		...
		if (this.type === GroupRuleType.Any) return this.rules.some((r) => r.passes(dayParts));
...
var parseFlags = {
	...
	YY: [twoDigits, (d, v) => {
		const cent = +(/* @__PURE__ */ new Date()).getFullYear().toString().substr(0, 2);
...
function startOfWeek(date, firstDayOfWeek = 1) {
	...
	return addDays(date, day >= firstDayOfWeek ? firstDayOfWeek - day : -(7 - (firstDayOfWeek - day)));
}
...
function getDateFromParts(parts, timezone = "") {
	...
	if (timezone) return toDate$1(`${pad(year, 4)}-${pad(month, 2)}-${pad(day, 2)}T${pad(hrs, 2)}:${pad(min, 2)}:${pad(sec, 2)}.${pad(ms, 3)}`, { timeZone: timezone });
...
function getMonthParts(month, year, firstDayOfWeek) {
	...
	const numWeeks = getWeeksInMonth(firstDayOfMonth, { weekStartsOn });
	const weeknumbers = [];
...
function getWeekdayDates() {
	...
	const month = 1;
	const day = 5;
	for (let i = 0; i < daysInWeek; i++) dates.push(getDateFromParts({
		year,
		month,
		day: day + i,
		hours: 12
...
function getDayNames(length, localeId = void 0) {
	const dtf = new Intl.DateTimeFormat(localeId, { weekday: length });
	return getWeekdayDates().map((d) => dtf.format(d));
}
function getHourDates() {
	const dates = [];
	for (let i = 0; i <= 24; i++) dates.push(new Date(2e3, 0, 1, i));
	return dates;
}
function getRelativeTimeNames(localeId = void 0) {
	...
	return units.reduce((names, unit) => {
		names[unit] = rtf.formatToParts(100, unit)[1].unit;
		return names;
	}, {});
}
function getMonthDates() {
	const dates = [];
	for (let i = 0; i < 12; i++) dates.push(new Date(2e3, i, 15));
	return dates;
}
...
function getDatePartOptions(parts, range, rule) {
	...
	for (let i = min; i <= max; i++) if (rule == null || datePartIsValid(i, rule, parts)) options.push({
		value: i,
		label: pad(i, padding)
	});
	return options;
...
function getNearestDatePart(parts, range, value, rule) {
	const result = getDatePartOptions(parts, range, rule).reduce((prev, opt) => {
		if (opt.disabled) return prev;
		if (isNaN(prev)) return opt.value;
		const diffPrev = Math.abs(prev - value);
		return Math.abs(opt.value - value) < diffPrev ? opt.value : prev;
	}, NaN);
...
function parseDate(dateString, mask, locale) {
	return normalizeMasks(mask, locale).map((m) => {
		if (typeof m !== "string") throw new Error("Invalid mask");
		let str = dateString;
		if (str.length > 1e3) return false;
		let isValid = true;
		const dp = {};
		m.replace(token, ($0) => {
			if (parseFlags[$0]) {
		...
		const today = /* @__PURE__ */ new Date();
		if (dp.hours != null) {
			if (dp.isPm === true && +dp.hours !== 12) dp.hours = +dp.hours + 12;
			else if (dp.isPm === false && +dp.hours === 12) dp.hours = 0;
		}
		let date;
		...
		} else date = locale.getDateFromParts({
...
var Attribute = class {
	constructor(config, theme, locale) {
		...
		__publicField(this, "locale");
		const { dates } = Object.assign(this, {
			hashcode: "",
			order: 0,
			pinPage: false
		}, config);
	...
	intersectsRange({ start, end }) {
		...
		for (const range of simpleRanges) if (range.intersectsDayRange(start.dayIndex, end.dayIndex)) return true;
		const repeatRanges = this.ranges.filter((r) => r.hasRepeat);
		if (!repeatRanges.length) return false;
		let day = start;
		if (this.maxRepeatSpan > 1) day = this.locale.getDateParts(addDays(day.date, -this.maxRepeatSpan));
		while (day.dayIndex <= end.dayIndex) {
			for (const range of repeatRanges) if (range.startsOnDay(day)) return true;
...
function showPopover(opts) {
	if (document) document.dispatchEvent(new CustomEvent("show-popover", { detail: opts }));
}
function hidePopover(opts) {
	if (document) document.dispatchEvent(new CustomEvent("hide-popover", { detail: opts }));
}
function togglePopover(opts) {
	if (document) document.dispatchEvent(new CustomEvent("toggle-popover", { detail: opts }));
}
function getPopoverEventHandlers(opts) {
	...
	const mouseMoveHandler = (e) => {
		if (!hovered) {
			hovered = true;
			if (hover || hoverFocus) showPopover({
				...opts,
				target: opts.target || e.currentTarget
			});
		}
	...
	const focusInHandler = (e) => {
		if (!focused) {
			focused = true;
			if (focus || hoverFocus) showPopover({
				...opts,
				target: opts.target || e.currentTarget
			});
		}
...
var addHorizontalSwipeHandler = (element, handler, { maxSwipeTime: maxSwipeTime2, minHorizontalSwipeDistance: minHorizontalSwipeDistance2, maxVerticalSwipeDistance: maxVerticalSwipeDistance2 }) => {
	...
	function touchEnd(e) {
		...
		if ((/* @__PURE__ */ new Date()).getTime() - startTime < maxSwipeTime2) {
...
function useDarkMode(config) {
	...
	function moListener() {
		...
		isDark.value = document.querySelector(selector).classList.contains(darkClass);
	}
	...
	function setup() {
		...
		if (type === "string" && config.value.toLowerCase() === "system") setupSystem();
		else if (type === "object") setupClass(config.value);
		else isDark.value = !!config.value;
	}
	const stopWatch = watch(() => config.value, () => setup(), { immediate: true });
...
function normalizeConfig(color, config, defaultProfile = _defaultProfile) {
	...
	} else if (isObject(config)) if (hasAny(config, targetProps)) root2 = { ...config };
	else root2 = {
		base: { ...config },
		start: { ...config },
		end: { ...config }
	...
	Object.entries(result).forEach(([targetType, targetConfig]) => {
		...
		} else if (isObject(targetConfig)) if (hasAny(targetConfig, displayProps)) result[targetType] = { ...targetConfig };
		else result[targetType] = {};
...
var HighlightRenderer = class {
	...
	render({ data: data2, onStart, onEnd }, glyphs) {
		...
		if (onStart && onEnd) highlights.push({
			...start,
			key,
...
var Theme = class {
	...
	normalizeGlyphs(attr) {
		this.renderers.forEach((renderer) => {
			...
			if (attr[type] != null) attr[type] = renderer.normalizeConfig(this.color, attr[type]);
		});
	}
	prepareRender(glyphs = {}) {
		this.renderers.forEach((renderer) => {
...
function createBase(props) {
	...
	const locale = computed(() => {
		...
		return new Locale(isObject(props.locale) ? props.locale : {
			id: props.locale,
	...
	const disabledDates = computed(() => {
		...
		if (minDate.value != null) dates.push({
			start: null,
			end: addDays(locale.value.toDate(minDate.value), -1)
		});
		if (maxDate.value != null) dates.push({
...
function createCalendar(props, { slots, emit }) {
	...
	provideSlots(slots);
	const { theme, color, displayMode, locale, masks: masks2, minDate, maxDate, disabledAttribute, disabledDates } = useOrCreateBase(props);
	...
	const forDays = (pages, fn) => {
		for (const page of pages) for (const day of page.days) if (fn(day) === false) return;
	};
	...
	const attributes = computed(() => {
		...
		if (disabledAttribute.value) result.push(disabledAttribute.value);
		return result;
	});
	...
	const getWeeknumberPosition = (column, columnFromEnd) => {
		...
		if (isBoolean_1(showWeeknumbers2)) return showWeeknumbers2 ? "left" : "";
		if (showWeeknumbers2.startsWith("right")) return columnFromEnd > 1 ? "right" : showWeeknumbers2;
	...
	const getTargetPageRange = (page, opts = {}) => {
		...
		let fromPage = addPages$1(page, position > 0 ? 1 - position : -(count.value + position), view);
		let toPage = addPages$1(fromPage, count.value - 1, view);
		if (!force) {
			if (pageIsBeforePage(fromPage, minPage.value)) fromPage = minPage.value;
			else if (pageIsAfterPage(toPage, maxPage.value)) fromPage = addPages$1(maxPage.value, 1 - count.value);
	...
	const getPageTransition = (oldPage, newPage, defaultTransition = "") => {
		...
		if (!moveNext2 && !movePrev2) return "fade";
		if (defaultTransition === "slide-v") return movePrev2 ? "slide-down" : "slide-up";
		return movePrev2 ? "slide-right" : "slide-left";
	};
	const refreshPages = (opts = {}) => {
		return new Promise((resolve, reject) => {
			const { position = 1, force = false, transition } = opts;
			const { fromPage } = getTargetPageRange(pageIsValid(opts.page) ? opts.page : getDefaultInitialPage(), {
				position,
				force
			});
			const pages = [];
	...
	const targetBy = (pages) => {
		return addPages$1(firstPage.value ?? getDateAddress(/* @__PURE__ */ new Date()), pages);
	};
	const canMove = (target, opts = {}) => {
		...
		return pageRangeToArray(opts.fromPage, opts.toPage, _view.value, locale.value).map((p) => pageIsBetweenPages(p, minPage.value, maxPage.value)).some((val) => val);
	};
	...
	const onKeydown = (event) => {
		...
		if (day != null) onDayKeydown(day, event);
	};
	...
	onMounted(() => {
		if (!props.disablePageSwipe && containerRef.value) removeHandlers2 = addHorizontalSwipeHandler(containerRef.value, ({ toLeft = false, toRight = false }) => {
			if (toLeft) moveNext();
			else if (toRight) movePrev();
		}, getDefault("touch"));
	});
	onUnmounted(() => {
		_pages.value = [];
	...
	setup(props, { emit }) {
		...
		const alignment = computed(() => {
			...
			if ([
				...
				"top",
				"left"
			].includes(alignment2)) return isLeftRight ? "top" : "left";
			if ([
				"end",
				"bottom",
				"right"
			].includes(alignment2)) return isLeftRight ? "bottom" : "right";
		...
		function setupPopper() {
			nextTick(() => {
				...
				if (popper && popper.state.elements.reference !== el) destroyPopper();
				if (!popper) popper = createPopper(el, popoverRef.value, popperOptions.value);
				else popper.update();
			});
		}
		...
		function isCurrentTarget(target) {
			...
			return resolveEl(target) === popper.state.elements.reference;
		}
		...
		function toggle(opts = {}) {
			...
			if (state2.isVisible && isCurrentTarget(opts.target)) hide(opts);
			else show(opts);
		}
		function onDocumentClick(e) {
			if (!popper) return;
			const popperRef = popper.state.elements.reference;
			if (!popoverRef.value || !popperRef) return;
			const target = e.target;
			if (elementContains(popoverRef.value, target) || elementContains(popperRef, target)) return;
			hide({ force: true });
		}
		function onDocumentKeydown(e) {
			if (e.key === "Esc" || e.key === "Escape") hide();
		}
		...
		function onMouseOver() {
			...
			if (state2.isInteractive && ["hover", "hover-focus"].includes(state2.visibility)) show();
		}
		function onMouseLeave() {
			state2.isHovered = false;
			if (!popper) return;
			const popperRef = popper.state.elements.reference;
			if (state2.autoHide && !state2.isFocused && (!popperRef || popperRef !== document.activeElement) && ["hover", "hover-focus"].includes(state2.visibility)) hide();
		}
		function onFocusIn() {
			state2.isFocused = true;
			if (state2.isInteractive && ["focus", "hover-focus"].includes(state2.visibility)) show();
		}
		...
		watch(() => state2.placement, updateDirection, { immediate: true });
		onMounted(() => {
			addEvents();
		});
		onUnmounted(() => {
...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", {
		...
		default: withCtx(() => [_ctx.isVisible ? (openBlock(), createElementBlock("div", mergeProps({
			...
			data: _ctx.data,
			hide: _ctx.hide
		}, () => [createTextVNode(toDisplayString(_ctx.data), 1)]), createBaseVNode("span", { class: normalizeClass([
			"vc-popover-caret",
			`direction-${_ctx.direction}`,
...
var Popover = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$7]]);
...
var _sfc_main$j = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const indicator = computed(() => {
			...
			if (content) return { class: `vc-bar vc-day-popover-row-bar vc-attr vc-${content.base.color}` };
			if (highlight) return { class: `vc-highlight-bg-solid vc-day-popover-row-highlight vc-attr vc-${highlight.base.color}` };
			if (dot) return { class: `vc-dot vc-attr vc-${dot.base.color}` };
			if (bar) return { class: `vc-bar vc-day-popover-row-bar vc-attr vc-${bar.base.color}` };
			return null;
		});
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$c, [unref(indicator) ? (openBlock(), createElementBlock("div", _hoisted_2$b, [createBaseVNode("span", { class: normalizeClass(unref(indicator).class) }, null, 2)])) : createCommentVNode("", true), createBaseVNode("div", _hoisted_3$9, [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(toDisplayString(__props.attribute.popover ? __props.attribute.popover.label : "No content provided"), 1)])])]);
		};
	}
});
var _sfc_main$i = /* @__PURE__ */ defineComponent({
	...
	props: { name: null },
	setup(__props) {
		const slot = useSlot(__props.name);
		return (_ctx, _cache) => {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Popover, {
				...
				default: withCtx(({ data: { day, attributes }, hide }) => [createVNode(_sfc_main$i, {
					name: "day-popover",
					day,
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_1$b, [unref(masks2).dayPopover ? (openBlock(), createElementBlock("div", _hoisted_2$a, toDisplayString(dayTitle(day)), 1)) : createCommentVNode("", true), (openBlock(true), createElementBlock(Fragment, null, renderList(attributes, (attribute) => {
...
var _hoisted_3$8 = [/* @__PURE__ */ createBaseVNode("polyline", { points: "9 18 15 12 9 6" }, null, -1)];
function _sfc_render$6(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$a, _hoisted_3$8);
}
var IconChevronRight = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$6]]);
var _sfc_main$f = {};
var _hoisted_1$9 = {
	"stroke-linecap": "round",
	"stroke-linejoin": "round",
...
var _hoisted_3$7 = [/* @__PURE__ */ createBaseVNode("polyline", { points: "15 18 9 12 15 6" }, null, -1)];
function _sfc_render$5(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$9, _hoisted_3$7);
}
var IconChevronLeft = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$5]]);
var _sfc_main$e = {};
var _hoisted_1$8 = {
	"stroke-linecap": "round",
	"stroke-linejoin": "round",
...
var _hoisted_3$6 = [/* @__PURE__ */ createBaseVNode("polyline", { points: "6 9 12 15 18 9" }, null, -1)];
function _sfc_render$4(_ctx, _cache) {
	return openBlock(), createElementBlock("svg", _hoisted_1$8, _hoisted_3$6);
}
var IconChevronDown = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$4]]);
var _sfc_main$d = {};
var _hoisted_1$7 = {
	fill: "none",
	"stroke-linecap": "round",
...
var _hoisted_3$5 = [/* @__PURE__ */ createBaseVNode("path", { d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }, null, -1)];
...
var icons = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	...
	IconChevronLeft,
	IconChevronRight,
	IconClock: /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$3]])
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				unref(show).prev ? (openBlock(), createElementBlock("button", {
					...
					onKeydown: _cache[1] || (_cache[1] = withKeys((...args) => unref(movePrev) && unref(movePrev)(...args), ["space", "enter"]))
					...
					_: 1
				}, 8, ["disabled"])], 40, _hoisted_1$6)) : createCommentVNode("", true),
				unref(show).title ? (openBlock(), createElementBlock("div", _hoisted_2$5, [createVNode(_sfc_main$i, { name: "header-title-wrapper" }, {
					default: withCtx(() => [withDirectives((openBlock(), createElementBlock("button", _hoisted_3$4, [createVNode(_sfc_main$i, {
						name: "header-title",
						title: __props.page.title
					}, {
						default: withCtx(() => [createBaseVNode("span", null, toDisplayString(__props.page.title), 1)]),
						_: 1
					}, 8, ["title"])])), [[unref(popoverDirective), unref(navPopoverOptions)]])]),
					_: 1
				...
				unref(show).next ? (openBlock(), createElementBlock("button", {
					...
					onKeydown: _cache[3] || (_cache[3] = withKeys((...args) => unref(moveNext) && unref(moveNext)(...args), ["space", "enter"]))
				}, [createVNode(_sfc_main$i, {
					...
					_: 1
				}, 8, ["disabled"])], 40, _hoisted_4$3)) : createCommentVNode("", true)
			], 6);
		};
	}
});
...
var _sfc_main$a = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function movePrev() {
			...
			if (monthMode.value) movePrevYear();
			movePrevYearGroup();
		}
		function moveNext() {
			if (!nextItemsEnabled.value) return;
			if (monthMode.value) moveNextYear();
			moveNextYearGroup();
		}
		...
		const monthItems = computed(() => getMonthItems(selectedYear.value, masks2.value.navMonths).map((item) => ({
			...item,
			click: () => move({
				month: item.month,
				year: item.year
		...
		const prevMonthItems = computed(() => getMonthItems(selectedYear.value - 1, masks2.value.navMonths));
		const prevMonthItemsEnabled = computed(() => prevMonthItems.value.some((i) => !i.isDisabled));
		const nextMonthItems = computed(() => getMonthItems(selectedYear.value + 1, masks2.value.navMonths));
		const nextMonthItemsEnabled = computed(() => nextMonthItems.value.some((i) => !i.isDisabled));
		const yearItems = computed(() => getYearItems(getStartYear(selectedYearGroup.value), getEndYear(selectedYearGroup.value)).map((item) => {
			return {
				...item,
				click: () => {
		...
		const prevYearItems = computed(() => getYearItems(getStartYear(selectedYearGroup.value - 1), getEndYear(selectedYearGroup.value - 1)));
		const prevYearItemsEnabled = computed(() => prevYearItems.value.some((i) => !i.isDisabled));
		const nextYearItems = computed(() => getYearItems(getStartYear(selectedYearGroup.value + 1), getEndYear(selectedYearGroup.value + 1)));
		...
		watch(() => selectedYear.value, (val) => selectedYearGroup.value = getYearGroupIndex(val));
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("button", {
					...
					_: 1
				}, 8, ["disabled"])], 40, _hoisted_3$3)
			]), createBaseVNode("div", _hoisted_4$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(activeItems), (item) => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Popover, {
				...
				class: normalizeClass([
					...
					`vc-${unref(color)}`,
					`vc-${unref(displayMode)}`
				])
			}, {
				default: withCtx(({ data: data2 }) => [createVNode(_sfc_main$9, { page: data2.page }, {
					default: withCtx(() => [createVNode(_sfc_main$i, { name: "nav" }, {
...
var _sfc_main$7 = defineComponent({
	...
	setup(props) {
		const { locale, theme, attributeContext, dayPopoverId, onDayClick, onDayMouseenter, onDayMouseleave, onDayFocusin, onDayFocusout, onDayKeydown } = useCalendar();
		...
		return {
			...
			dayContentProps: computed(() => {
				let tabindex;
				if (day.value.isFocusable) tabindex = "0";
				else tabindex = "-1";
				return {
					class: [
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.dayClasses) }, [
		_ctx.hasHighlights ? (openBlock(), createElementBlock("div", _hoisted_1$4, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.highlights, ({ key, wrapperClass, class: bgClass, style }) => {
			return openBlock(), createElementBlock("div", {
				key,
		...
		_ctx.hasDots ? (openBlock(), createElementBlock("div", _hoisted_2$3, [createBaseVNode("div", _hoisted_3$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.dots, ({ key, class: bgClass, style }) => {
		...
		_ctx.hasBars ? (openBlock(), createElementBlock("div", _hoisted_4$1, [createBaseVNode("div", _hoisted_5$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.bars, ({ key, class: bgClass, style }) => {
			return openBlock(), createElementBlock("span", {
				key,
				class: normalizeClass(bgClass),
				style: normalizeStyle(style)
...
var CalendarDay = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$2]]);
var _hoisted_1$3 = { class: "vc-weekdays" };
var _hoisted_2$2 = ["onClick"];
var _sfc_main$5 = defineComponent({
	components: {
		CalendarHeader: _sfc_main$b,
		CalendarPage: /* @__PURE__ */ defineComponent({
			inheritAttrs: false,
			__name: "CalendarPage",
			setup(__props) {
				const { page } = usePage();
				...
				return (_ctx, _cache) => {
					return openBlock(), createElementBlock("div", {
						...
						"is-lg": "",
						"hide-arrows": ""
					}, null, 8, ["page"]), createBaseVNode("div", { class: normalizeClass(["vc-weeks", { [`vc-show-weeknumbers-${unref(page).weeknumberPosition}`]: unref(page).weeknumberPosition }]) }, [createBaseVNode("div", _hoisted_1$3, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(page).weekdays, ({ weekday, label }, i) => {
						return openBlock(), createElementBlock("div", {
							key: i,
							class: normalizeClass(`vc-weekday vc-weekday-${weekday}`)
						}, toDisplayString(label), 3);
					}), 128))]), (openBlock(true), createElementBlock(Fragment, null, renderList(unref(page).viewWeeks, (week) => {
						return openBlock(), createElementBlock("div", {
						...
						}, toDisplayString(week.weeknumberDisplay), 9, _hoisted_2$2)], 2)) : createCommentVNode("", true), (openBlock(true), createElementBlock(Fragment, null, renderList(week.days, (day) => {
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock(Fragment, null, [
		createBaseVNode("div", mergeProps({ "data-helptext": "Press the arrow keys to navigate by day, Home and End to navigate to week ends, PageUp and PageDown to navigate by month, Alt+PageUp and Alt+PageDown to navigate by year" }, _ctx.$attrs, {
			...
			ref: "containerRef"
		}), [createBaseVNode("div", { class: normalizeClass(["vc-pane-container", { "in-transition": _ctx.inTransition }]) }, [
			createBaseVNode("div", _hoisted_1$2, [_ctx.firstPage ? (openBlock(), createBlock(_component_CalendarHeader, {
				key: 0,
				page: _ctx.firstPage,
				"is-lg": "",
				"hide-title": ""
			...
			createVNode(Transition, {
				...
				default: withCtx(() => [(openBlock(), createElementBlock("div", {
					...
					style: normalizeStyle({ gridTemplateColumns: `repeat(${_ctx.columns}, 1fr)` })
					...
					return openBlock(), createBlock(_component_CalendarPageProvider, {
						...
						default: withCtx(() => [createVNode(_component_CalendarSlot, {
							name: "page",
							page
						}, {
							default: withCtx(() => [createVNode(_component_CalendarPage)]),
							_: 2
						}, 1032, ["page"])]),
						_: 2
					}, 1032, ["page"]);
...
var Calendar = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$1]]);
...
function createDatePicker(props, { emit, slots }) {
	...
	const inputMask = computed(() => {
		if (isTimeMode.value) return props.is24hr ? masks2.value.inputTime24hr : masks2.value.inputTime;
		if (isDateTimeMode.value) return props.is24hr ? masks2.value.inputDateTime24hr : masks2.value.inputDateTime;
	...
	const inputMaskPatch = computed(() => {
		if (inputMaskHasTime.value && inputMaskHasDate.value) return "dateTime";
	...
	const popover = computed(() => {
		...
		return defaultsDeep_1({}, props.popover, getDefault("datePicker.popover"), { target });
	});
	...
	const dragAttribute = computed(() => {
		if (!isRange.value || !hasValue(dragValue.value)) return null;
		const attribute = {
			key: "select-drag",
			...props.dragAttribute,
		...
		const { dot, bar, highlight, content } = attribute;
		if (!dot && !bar && !highlight && !content) attribute.highlight = { startEnd: { fillMode: "outline" } };
		return attribute;
	});
	const attributes = computed(() => {
		const attrs = isArray(props.attributes) ? [...props.attributes] : [];
		if (dragAttribute.value) attrs.unshift(dragAttribute.value);
		else if (selectAttribute.value) attrs.unshift(selectAttribute.value);
		return attrs;
	});
	...
	function normalizeValue(value, config2, patch, targetPriority) {
		...
		if (hasRangeValue(value)) return sortRange({
			start: locale.value.toDate(value.start, {
				...config2[0],
				fillDate: valueStart.value ?? void 0,
				patch
			}),
			end: locale.value.toDate(value.end, {
				...config2[1],
	...
	function updateValue(value, opts = {}) {
		...
		return new Promise((resolve) => {
			...
			if (debounce > 0) updateTimeout = window.setTimeout(() => {
				resolve(forceUpdateValue(value, args));
			}, debounce);
			else resolve(forceUpdateValue(value, args));
		});
	}
	function forceUpdateValue(value, { config: config2 = modelConfig.value, patch = "dateTime", clearIfEqual = false, formatInput: fInput = true, hidePopover: hPopover = false, dragging = isDragging.value, targetPriority, moveToValue: mValue = false } = {}) {
		let normalizedValue = normalizeValue(value, normalizeDateConfig(config2), patch, targetPriority);
		if (valueIsDisabled(normalizedValue)) {
			if (dragging) return null;
			normalizedValue = dateValue.value;
			hPopover = false;
		} else if (normalizedValue == null && props.isRequired) normalizedValue = dateValue.value;
		else if (normalizedValue != null && valuesAreEqual(dateValue.value, normalizedValue) && clearIfEqual) normalizedValue = null;
		...
		if (mValue) nextTick(() => moveToValue(targetPriority ?? "start"));
	...
	function formatInput() {
		nextTick(() => {
			...
			if (isRange.value) inputValues.value = [value && value.start, value && value.end];
			else inputValues.value = [value, ""];
		});
	}
	...
	function getDateParts2(value) {
		if (isRange.value) return [value && value.start ? locale.value.getDateParts(value.start) : null, value && value.end ? locale.value.getDateParts(value.end) : null];
	...
	function handleDayClick(day) {
		...
		if (isRange.value) {
			...
			if (dragging) dragTrackingValue = {
				start: day.startDate,
				end: day.endDate
			};
			else if (dragTrackingValue != null) dragTrackingValue.end = day.date;
			updateValue(dragTrackingValue, {
				...opts,
				dragging
			});
		} else updateValue(day.date, {
			...opts,
	...
	async function moveToValue(target, opts = {}) {
		...
		const page = getPageAddressForDate(hasRangeValue(dValue) ? start ? dValue.start : dValue.end : dValue, "monthly", locale.value);
	...
	watch(() => props.isRange, (val) => {
		if (val) console.warn("The `is-range` prop will be deprecated in future releases. Please use the `range` modifier.");
	}, { immediate: true });
	watch(() => isRange.value, () => {
	...
	watch(() => rules.value, () => {
		if (isObject(props.rules)) forceUpdateValue(props.modelValue, {
			formatInput: true,
			hidePopover: false
		});
	});
...
function createTimePicker(props) {
	...
	const date = computed(() => {
		...
		if (parts.value.hours === 24) date2 = /* @__PURE__ */ new Date(date2.getTime() - 1);
		return date2;
	});
	...
	const isAM = computed({
		...
		set(value) {
			...
			if (value && hValue >= 12) hValue -= 12;
			else if (!value && hValue < 12) hValue += 12;
...
var _sfc_main$4 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(["vc-base-select", {
...
var _hoisted_7 = /* @__PURE__ */ createBaseVNode("span", { class: "vc-time-colon" }, ":", -1);
var _hoisted_8 = /* @__PURE__ */ createBaseVNode("span", { class: "vc-time-colon" }, ":", -1);
var _hoisted_9 = /* @__PURE__ */ createBaseVNode("span", { class: "vc-time-decimal" }, ".", -1);
var _sfc_main$3 = /* @__PURE__ */ defineComponent({
	__name: "TimePicker",
	props: { position: null },
	setup(__props, { expose }) {
		const timePicker = createTimePicker(__props);
		expose(timePicker);
		const { locale, isValid, date, hours: hours2, minutes, seconds, milliseconds, options, hourOptions, isTimeMode, isAM, isAMOptions, is24hr, showHeader, timeAccuracy } = timePicker;
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(["vc-time-picker", [{
				"vc-invalid": !unref(isValid),
				"vc-attached": !unref(isTimeMode)
			}]]) }, [createVNode(_sfc_main$i, { name: "time-header" }, {
				default: withCtx(() => [unref(showHeader) && unref(date) ? (openBlock(), createElementBlock("div", _hoisted_1, [
				...
				unref(timeAccuracy) > 1 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [_hoisted_7, createVNode(_sfc_main$4, {
				...
				unref(timeAccuracy) > 2 ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [_hoisted_8, createVNode(_sfc_main$4, {
				...
				unref(timeAccuracy) > 3 ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [_hoisted_9, createVNode(_sfc_main$4, {
					...
					"align-left": ""
				}, null, 8, ["modelValue", "options"])], 64)) : createCommentVNode("", true),
...
var _sfc_main$2 = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		const { attributes, calendarRef, color, displayMode, isDateTimeMode, isTimeMode, isRange, onDayClick, onDayMouseEnter, onDayKeydown } = useDatePicker();
		...
		return (_ctx, _cache) => {
			return unref(isTimeMode) ? (openBlock(), createElementBlock("div", {
			...
			}), 128))], 2)) : (openBlock(), createBlock(Calendar, {
				key: 1,
				...
				footer: withCtx(() => [unref(isDateTimeMode) ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(positions), (position) => {
					return openBlock(), createBlock(_sfc_main$3, {
						key: position,
						position
					}, null, 8, ["position"]);
				}), 128)) : createCommentVNode("", true), createVNode(_sfc_main$i, { name: "dp-footer" })]),
				_: 1
			}, 8, [
				"attributes",
				"onDayclick",
...
var _sfc_main = defineComponent({
	...
	components: {
		...
		DatePickerPopover: /* @__PURE__ */ defineComponent({
			inheritAttrs: false,
			__name: "DatePickerPopover",
			setup(__props) {
				const { datePickerPopoverId, color, displayMode, popoverRef, onPopoverBeforeShow, onPopoverAfterShow, onPopoverBeforeHide, onPopoverAfterHide } = useDatePicker();
				return (_ctx, _cache) => {
					return openBlock(), createBlock(Popover, {
						...
						default: withCtx(() => [createVNode(_sfc_main$2, normalizeProps(guardReactiveProps(_ctx.$attrs)), null, 16)]),
						_: 1
					}, 8, [
						"id",
						"class",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return _ctx.$slots.default ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(_ctx.slotCtx))), createVNode(_component_DatePickerPopover, normalizeProps(guardReactiveProps(_ctx.$attrs)), null, 16)], 64)) : (openBlock(), createBlock(_component_DatePickerBase, normalizeProps(mergeProps({ key: 1 }, _ctx.$attrs)), null, 16));
}
...
var index = { install };
//#endregion
export { Calendar, DatePicker, Popover, _sfc_main$j as PopoverRow, createCalendar, createDatePicker, index as default, popoverDirective, setupDefaults as setupCalendar, useCalendar, useDatePicker };
